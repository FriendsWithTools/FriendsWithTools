...
const RentRented = () => {
  ...
  useEffect(() => {
    const ownerId = "ba6295e8-ceca-424b-a148-0467a19ab25f"; // Replace with the actual ownerId
    const userId = "ba6295e8-ceca-424b-a148-0467a19ab25f"; // Replace with the actual userId
